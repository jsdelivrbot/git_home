...
After analyzing each predictor, it is found that the low median house value is postively related to `crim`, `indus`, `nox`, `age`, `rad`, `ptratio`, `tax` and `lstat`; while `zn`, `chas`, `rm` and `dis` is negatively related to the low median house value.
...
Simiar to the analysis of low median house value suburbs, the boxplots of suburbs averaging more than 8 rooms per dwelling is plotted (green) against the sample population (lightgray).
