...
lasso_prediction_RMSE <- function(lasso_model, lasso_set){
    ...
    predict_test <- predict(lasso_model, cbind(lasso_matrix[, -c(1, 163)], interact_terms))
    
    
    write.csv(cbind(lasso_set, predict_test), "predict_test.csv")
    RMSE <- mean((predict_test - lasso_matrix[, "price"])^2)^.5
